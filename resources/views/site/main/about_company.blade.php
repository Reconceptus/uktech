            ...
            <section class="indent-block">
                <div class="container">
                    ...
                    <ul class="certificates-list">
                        ...
                        <li>
                            <a href="{{$img}}" class="venobox-btn" data-css="image-gallery" data-gall="certificate-gallery-1">
                                <img src="{{$img}}" alt="{{ str_replace(['.pdf','.jpg','.jpeg','.png'],'',$sl_1['orig_name']) }}">
                            </a>
                        </li>
                        @endforeach
                    </ul>
                    ...
                    <h3 class="text-center mb-md">{!! $langSt($about['block_4_2']) !!}</h3>
                     <ul class="certificates-list">
                         @foreach($slider_2 as $sl_2)
                             ...
                             <li>
                                 <a href="{{$img}}" class="venobox-btn" data-css="image-gallery" data-gall="certificate-gallery-2">
                                     <img src="{{$img}}" alt="{{ str_replace(['.pdf','.jpg','.jpeg','.png'],'',$sl_1['orig_name']) }}">
                                 </a>
                             </li>
                         @endforeach
